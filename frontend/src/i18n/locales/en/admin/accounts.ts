export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        autoProbe: 'Automatically detect upstream information',
        autoProbeHint: 'When enabled, the global schedule refreshes the upstream declared rate and balance. This switch alone does not change the account rate.',
        template: 'Probe template',
        templateGeneral: 'General template',
        templateNewAPI: 'NewAPI',
        baseUrl: 'Request URL',
        baseUrlPlaceholder: 'https://api.newapi.com',
        baseUrlHint: 'Request URL used to query the NewAPI balance.',
        accessToken: 'Access token (from Personal Security Settings)',
        accessTokenPlaceholder: 'Generate in Personal Security Settings',
        accessTokenHint: 'Leave blank to keep the saved access token.',
        userId: 'User ID',
        userIdPlaceholder: 'For example: 114514',
        userIdHint: 'The NewAPI template requires the user ID associated with the access token.',
        syncRate: 'Sync upstream declared rate',
        syncRateHint: 'Update the account rate after each successful probe, using the base rate excluding peak hours. Failed probes or declarations outside the allowed range leave it unchanged. Enabling this also turns on "Automatically detect upstream information".',
        ...
        manualProbe: 'Probe upstream information now',
        ...
        probeMissingAccessToken: 'The NewAPI template is missing an access token.',
        probeMissingBaseUrl: 'The NewAPI template is missing a request URL.',
        probeMissingUserId: 'The NewAPI template requires a user ID.',
        probeBaseUrlRequired: 'The NewAPI template requires a request URL.',
        probeAccessTokenRequired: 'The NewAPI template requires an access token.',
        probeUserIdRequired: 'The NewAPI template requires a user ID.',
        probeInvalidUserId: 'The NewAPI user ID is invalid.',
