export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        quotaDetails: '上游额度',
        autoProbe: '自动探测上游信息',
        autoProbeHint: '启用后按全局周期刷新上游声明倍率及余额；此开关本身不会修改账号倍率。',
        template: '探测模板',
        templateGeneral: '通用模板',
        templateNewAPI: 'NewAPI',
        baseUrl: '请求地址',
        baseUrlPlaceholder: 'https://api.newapi.com',
        baseUrlHint: 'NewAPI 用于查询余额的请求地址。',
        accessToken: '访问令牌（在个人安全设置里获取）',
        accessTokenPlaceholder: '在安全设置生成',
        accessTokenHint: '留空则保留已保存的访问令牌。',
        userId: '用户 ID',
        userIdPlaceholder: '例如：114514',
        userIdHint: 'NewAPI 模板请求需要与访问令牌匹配的用户 ID。',
        syncRate: '同步上游声明倍率',
        syncRateHint: '成功探测后自动更新账号倍率，同步的是不含高峰的基准倍率；探测失败或声明超出允许范围时保持不变。开启本项会同时打开“自动探测上游信息”。',
        syncRateManagedHint: '当前倍率由上游声明的基准倍率（不含高峰）自动维护。',
        syncedRateTooltip: '该账号倍率由上游声明的基准倍率（不含高峰）自动同步',
        manualProbe: '立即探测上游信息',
        queryQuota: '查询上游额度',
        refreshQuota: '刷新上游额度',
        notQueried: '未查询',
        queryingQuota: '查询中...',
        ...
        probeMissingAccessToken: 'NewAPI 模板缺少访问令牌。',
        probeMissingBaseUrl: 'NewAPI 模板缺少请求地址。',
        probeMissingUserId: 'NewAPI 模板缺少用户 ID。',
        probeBaseUrlRequired: 'NewAPI 模板需要请求地址。',
        probeAccessTokenRequired: 'NewAPI 模板需要访问令牌。',
        probeUserIdRequired: 'NewAPI 模板需要用户 ID。',
        probeInvalidUserId: 'NewAPI 用户 ID 格式无效。',
